    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-6">
      ...
      >
        ...
        <p className="text-gray-600 text-sm mb-6">
          Your mentorship batch coordinator will also contact you shortly.
        </p>

        <a
          href="https://wa.me/2349134598884?text=Hello%20I%20just%20completed%20my%20Grant%20Forex%20mentorship%20payment"
        ...
        >
          <FaWhatsapp className="size-4 mr-2" /> Join WhatsApp
        </a>
      </motion.div>
    </div>
  );
